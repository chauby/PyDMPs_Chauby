...
# %%
demo_traj = np.load('../demo_trajectory/LKnee_arr_gaits.npz')['date']

data_len = len(demo_traj[0,:])
...
# DMP learning
dmp = dmp_discrete(n_dmps=y_demo.shape[0], n_bfs=200, dt=1.0/data_len, alpha_y=60.0, beta_y=10.0)
...
y_reproduce_2, dy_reproduce_2, ddy_reproduce_2 = dmp.reproduce(tau=1.0, initial=[y_demo[0,0]+160, y_demo[1,0]], goal=[y_demo[0, -1]-100, y_demo[1, -1]-10])
